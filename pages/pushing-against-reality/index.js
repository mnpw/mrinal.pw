    ...
    return (
        <Layout>
            ...
            <blockquote>
                ...
                <p className="ref">— Richard Hamming, <Link href="https://www.cs.virginia.edu/~robins/YouAndYourResearch.html"><a target="_blank" rel="noopener">You and Your Research</a></Link></p>
            </blockquote>
            <p>~</p>
            ...
            <blockquote>
                ...
                <p className="ref">— <Link href="https://twitter.com/fchollet/status/1361753155717931008"><a target="_blank" rel="noopener">François Chollet</a></Link></p>
            </blockquote>
            ...
            <blockquote>
                ...
                <p className="ref">— Zvi Mowshowitz, <Link href="https://www.lesswrong.com/posts/z8usYeKX7dtTWsEnk/more-dakka"><a target="_blank" rel="noopener">More Dakka</a></Link></p>
            </blockquote>
            <p>~</p>

            <p>A big thanks to <Link href="https://twitter.com/gwern"><a target="_blank" rel="noopener">Gwern</a></Link>, <Link href="https://twitter.com/ESYudkowsky"><a target="_blank" rel="noopener">Eliezer Yudkowsky</a></Link>, and <Link href="https://twitter.com/TheZvi"><a target="_blank" rel="noopener">Zvi Mowshowitz</a></Link>. Their explorations and ideas inspired this essay.</p>
        </Layout >
    )
}