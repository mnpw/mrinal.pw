...
export default function Posts() {
    return (
        <Layout>
            ...
            <p>
                Most engineers, if the tales are to be believed, are forged of unmatched brilliance. They play only with instruction manuals and machines. They finish their PhDs before they grow big enough in size to ride on a roller coaster. There are no prodigal origins in my case. Exposure to engineering happened ordinarily for me. Neither I was not opening machines when I was four, nor I was writing computer software when I was nine
            </p>
            <p>
